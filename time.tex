...
\begin{document}   
	...
	\end{gdblank} 
	\begin{gdblank}
		\centering\includegraphics[height=0.7\textheight]{gdlogo}
	\end{gdblank}
	\begin{gdblank}
		\frametitle{SPB}
	...
	\begin{gdblank}
		\begin{columns}
			...
			\end{column}
			\begin{column}{0.5\textwidth}
				\centering\includegraphics[width=0.7\textwidth]{gdlogo}
			\end{column}
		\end{columns}   
		\note{
	...
	\begin{gdblank}
		...
		\note{
			...
			С настенными часами у нас есть 2 основные проблемы, Drift \& Skew\\
			СНОС и СКОС
		}
	\end{gdblank}
	\begin{gdblank}
		...
		\begin{columns}
			\begin{column}{0.6\textwidth}
				...
				\includegraphics[scale=0.4]{clockdrift}
			\end{column}
			\begin{column}{0.4\textwidth}
				\centering
