...
{   
	...
	\begin{gdblank}
		...
		\centering\includegraphics[width=0.6\textwidth]{streaming} 
	\end{gdblank}
	\begin{gdblank}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.9\textwidth]{vector1}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.9\textwidth]{vector2}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1, Ben:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.9\textwidth]{vector3}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1, Ben:1, Dave:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.9\textwidth]{vector4}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1, Cathy:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.9\textwidth]{vector5}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1, Cathy:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.9\textwidth]{vector6}			
		\end{column}
		\begin{column}{0.5\textwidth}				
			Dave has two conflicting objects
			\begin{lstlisting}[language=Python]
...
vclock = Alice:1, Ben:1, Cathy:1, Dave:2
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.9\textwidth]{vector7}			
		\end{column}
		\begin{column}{0.5\textwidth}				
