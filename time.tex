...
\begin{document}   
	...
	\end{gdblank}
	\begin{gdblank}
		\centering\includegraphics[height=0.8\textheight]{garchitect} 
		\par\LARGE
		Software Architect
	\end{gdblank}
	\begin{gdblank}
	...
	\begin{gdblank}
		...
		\end{columns}   
		\note{
			Сегодня мы поговорим о времени. Но не о времени приключений или о журнале
		}         
	\end{gdblank}
	\begin{gdblank}
		\frametitle{Time}
	...
	\begin{gdblank}
		...
		\note{
			Но сначала давайте попробуем ответить на вопрос\\
			что такое время?
	...
	\begin{gdblank}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\centering\includegraphics[width=0.7\textwidth]{halflife} 
				\\Way of arrange the order of events 
			\end{column}
			\pause 
			\begin{column}{0.5\textwidth}
				\centering\includegraphics[width=0.7\textwidth]{einsteinspacetime} 
				\\Another dimension
			\end{column}
		\end{columns} 
		\note{
	...
	\begin{gdblank}
		...
		\note{
			...
			Название "Зурван" происходит от персидского «zruvan», что означает «время».
		} 
	\end{gdblank}
	\begin{gdblank}
		\frametitle{Time is ...}
	...
	\begin{gdblank}
		...
		\end{columns}     		
		\note{		
			И чтобы это доказать, давайте попробуем пройти небольшую викторину\\
			Викторину о времени\\
	...
	\begin{gdblank}
		...
		\note{
			...
			Или вообще никто. Особенно после вот таких ситуаций - 
		}
	\end{gdblank}   
	\begin{gdblank}
		\begin{columns}
	...
	\end{gdblank}  
	\begin{gdblank}		
		\centering\includegraphics[width=0.9\textwidth]{kernel-time-bug}
	\end{gdblank}  
	\begin{gdblank}		
