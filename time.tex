...
{   
	...
	\begin{gdblank}
		...
		\centering\includegraphics[width=0.5\textwidth]{streaming} 
	\end{gdblank}
	\begin{gdblank}
	...
	\begin{gdblank}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\centering\includegraphics[scale=0.5]{bigdata}
			\end{column}
			\pause 
			\begin{column}{0.5\textwidth}
	...
	\begin{gdblank}
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\includegraphics[width=\textwidth]{server-down}				
			\end{column}
			\pause
			\begin{column}{0.5\textwidth}
	...
	\begin{gdblank}
		...
		\includegraphics[scale=0.3]{suicide}
		\large \\
	...
	\begin{gdblank}
		\centering
		\begin{itemize}
			\item The important contribution of Lamport is that in a distributed system, clocks need not be synchronized absolutely
			\item It is not important that all processes agree on what the actual time is, but that they agree on the order in which events occur
	...
	\begin{gdblank}
		...
		\includegraphics[scale=0.3]{causality}
	...
	\begin{gdblank}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\includegraphics[width=0.8\textwidth]{robbery}			
			\end{column}
			\begin{column}{0.5\textwidth}
...
vclock = Alice:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.8\textwidth]{vector2}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1, Ben:1, Dave:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.8\textwidth]{vector3}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1, Cathy:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.8\textwidth]{vector4}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1, Cathy:1
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.8\textwidth]{vector5}			
		\end{column}
		\begin{column}{0.5\textwidth}				
			Dave has two conflicting objects
			\begin{lstlisting}[language=Python]
...
vclock = Alice:1, Ben:1, Cathy:1, Dave:2
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.8\textwidth]{vector6}			
		\end{column}
		\begin{column}{0.5\textwidth}				
...
vclock = Alice:1, Ben:1, Cathy:1, Dave:2
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.8\textwidth]{vector7}			
		\end{column}
		\begin{column}{0.5\textwidth}				
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=0.8\textwidth]{vector8}			
		\end{column}
		\begin{column}{0.5\textwidth}				
	...
	\begin{gdblank}		
		\centering
		\includegraphics[height=0.8\textheight]{mafia}
	\end{gdblank}
	\begin{gdblank}
		\frametitle{So, What!?}
		\centering
